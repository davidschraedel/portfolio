...
**Post-MVP (not blocking launch):** Case study routes exist as “coming soon” stubs; `handshakeLine` is in data but not rendered; PRD nice-to-haves (JSON-LD, sitemap, analytics, etc.) not built. Home intro and about copy still need cold-read validation before recruiter outreach — see [mvp.md](./mvp.md) §5.

**Product docs:** [prd.md](./prd.md) v3.3 · [mvp.md](./mvp.md) v2.3 · Content model: `src/data/profile.json` (single source of truth — reusable template for other projects)
...
| File                                 | What's in it                                                    |
| ------------------------------------ | --------------------------------------------------------------- |
| [prd.md](./prd.md)                   | Product requirements — features, users, success criteria (v3.3) |
| [mvp.md](./mvp.md)                   | Minimum product for success — validation gates (v2.3)           |
...
| Folder                       | Use                                                                                                                                                |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| [notes/](../ai/notes/)       | Research and brainstorming — starting with [initial-agent-instructions.md](../ai/notes/initial-agent-instructions.md) for initial refactor context |
| [roadmaps/](../ai/roadmaps/) | Plans and implementation roadmaps                                                                                                                  |
