...
**Post-MVP (not blocking launch):** Case study routes exist as “coming soon” stubs; PRD nice-to-haves (JSON-LD, sitemap, analytics, etc.) not built. Home intro and about copy still need cold-read validation before recruiter outreach — see [mvp.md](./mvp.md) §5.
...
| File                                 | What's in it                                                    |
| ------------------------------------ | --------------------------------------------------------------- |
| [prd.md](./prd.md)                   | Product requirements — features, users, success criteria (v3.4) |
| [mvp.md](./mvp.md)                   | Minimum product for success — validation gates (v2.4)           |
